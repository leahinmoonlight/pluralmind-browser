...
This plugin updates your Twitch chat to show the name, pronouns and username color of the headmate that's speaking.

## Installation

### Chrome, Edge and Opera
Get it free from the [Chrome Web Store](https://chromewebstore.google.com/detail/pluralmind-plurality-plug/ialdkignoppionpbamjmgoefnikiofjm).

### Firefox
Get it free from [Firefox Add-Ons](https://addons.mozilla.org/en-US/firefox/addon/pluralmind-twitch-plurality/).
